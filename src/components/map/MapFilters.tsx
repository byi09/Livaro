...
export default function MapFilters() {
  ...
  return (
    <div className="flex flex-wrap items-center gap-3 sm:gap-4 py-2 px-4 sm:px-6 shadow-lg z-20 bg-gradient-to-r from-white via-blue-50/20 to-white border-b border-blue-100/50 backdrop-blur-sm">
