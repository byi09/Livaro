...
export default function MapCatalog() {
  ...
  if (!mapBoundsReady) {
    return (
      <div className="flex flex-col px-6 py-4 gap-4 shadow-xl z-10 w-full h-full min-h-0 overflow-y-auto relative bg-white">
        <header>
  ...
  return (
    <div className="flex flex-col px-6 py-4 gap-4 shadow-xl z-10 h-full min-h-0 overflow-y-auto relative bg-white w-full">
      <header>
        <h1 className="text-2xl font-bold text-blue-900">Rental Listings</h1>
        <div className="flex justify-between items-center">
