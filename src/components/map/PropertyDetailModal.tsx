...
export default function PropertyDetailModal({
  ...
  useEffect(() => {
    const fetchImages = async () => {
      ...
      if (!actualFolder) {
        console.warn(
          `⚠️ No folder mapping found for property ID: ${property.properties.id}`
        )
        return
      }
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-5xl max-h-[95vh] overflow-hidden flex flex-col">
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="absolute top-4 left-4 flex gap-2">
            ...
            <button
              onClick={handleShare}
              className="p-2 rounded-full bg-white/90 text-gray-700 hover:bg-white shadow"
            >
          ...
          <div className="flex-1 p-6 space-y-6 overflow-y-auto">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <LocationBox
                  ...
                  points={[
                    `${property.properties.city} Elementary – 0.3 mi – ⭐${
                      8 + Math.floor(Math.random() * 2)
                    }/10`,
                    `${property.properties.city} Middle – 0.8 mi – ⭐${
                      7 + Math.floor(Math.random() * 2)
                    }/10`,
                    `${property.properties.city} High School – 1.2 mi – ⭐${
                      8 + Math.floor(Math.random() * 2)
                    }/10`,
                  ]}
                />
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                {property.properties.parkingSpaces &&
                  property.properties.parkingSpaces > 0 && (
                    <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
...
function SummaryCard({
  ...
  return (
    <div className="flex flex-col items-center border rounded-lg p-4 shadow-sm bg-white">
      <div className={`p-2 rounded-full ${color}`}>{icons[icon]}</div>
