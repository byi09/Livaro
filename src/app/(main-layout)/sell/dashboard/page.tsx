      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-8">
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-blue-700">
                <p>
                  Your property listings will become publicly visible and
                  searchable starting <strong>July 17th, 2025</strong>. Make
                  sure your listings are complete and ready to attract potential
                  tenants!
                </p>
              </div>
            </div>
              ...
              <div>
                ...
                <p className="mt-1 max-w-2xl text-sm text-gray-500">
                  ...
                  {contentType === 'properties'
                    ? 'property'
                    : 'apartment building'}{' '}
                  to edit details, continue setup, or manage your listing
                </p>
              </div>
                        ...
                        <div className="flex items-center">
                          ...
                          <div className="ml-4">
                            ...
                            <p className="text-sm text-gray-500">
                              {formatAddress(property)} • {property.bedrooms}{' '}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {properties.map(property => (
                    <ListingCard
                      ...
                      isLoading={clickingPropertyId === property.id}
        ...
        <div className="text-center">
          ...
          >
            ...
            Create New{' '}
            {contentType === 'properties' ? 'Property' : 'Apartment Building'}{' '}
            Listing
          </button>
        </div>
              ...
              <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                ...
                <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                  <button
                    ...
                    disabled={!showDeleteConfirm || isDeleting(showDeleteConfirm!)}
